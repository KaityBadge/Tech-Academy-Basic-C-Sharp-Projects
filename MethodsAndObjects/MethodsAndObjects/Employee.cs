...
namespace MethodsAndObjects
{
    ...
    ///// SECTION 3 : Using a generic type parameter
    //public class Employee<T> //this Employee class takes a generic type parameter T
    //{
    //    //creates a property of the Employee class called "Things" of type T (generic)
